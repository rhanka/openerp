...
| Outline, Anytype | none | No Graphify. Keep as source-available/public benchmarks only. | BSL or source-available application boundaries. | Public product and repository license signals only; no reuse. |
